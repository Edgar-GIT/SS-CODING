...
import { BookOpen, Code2, Rocket, Target, Trophy, Zap } from "lucide-react";
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-6 pb-16 lg:pt-8 lg:pb-24 grid lg:grid-cols-2 gap-8 lg:gap-10 items-start">
          <div className="space-y-8">
            ...
            <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.05] tracking-normal">
              Become an <span className="text-gradient-cosmic">elite programmer</span>
              <br />
              capable of building{" "}
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl leading-relaxed">
              Master any language, conquer every concept. Interactive guides, real exercises,
              quizzes, projects and a global ranking - all in one cosmic learning platform.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 max-w-md">
              {stats.map((stat) => (
                <div key={stat.label}>
                  ...
                  <div className="text-xs uppercase text-muted-foreground mt-1">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>

          <div className="relative flex justify-center lg:justify-start items-start mt-6 lg:mt-16 lg:-ml-8 xl:-ml-12">
            <div className="absolute top-1/3 left-1/4 w-3/4 h-3/4 bg-cosmic opacity-30 blur-3xl rounded-full animate-pulse-glow" />
            <img
              src={homeLogo}
              alt="SS Coding"
              className="relative w-full max-w-[480px] lg:max-w-[520px] animate-float-slow drop-shadow-[0_0_60px_oklch(0.55_0.25_285_/_0.6)] translate-x-[-4%] lg:translate-x-[-8%] translate-y-6 lg:translate-y-14"
            />
          </div>
        </div>
      </section>
      ...
      <section className="relative py-24 border-t border-border/40">
        <div className="mx-auto max-w-7xl px-6">
          <div className="max-w-2xl mb-16">
            <div className="text-sm font-semibold text-accent uppercase mb-3">The Arsenal</div>
            <h2 className="font-display text-4xl md:text-5xl font-bold leading-tight">
              Everything you need to <span className="text-gradient-cosmic">level up</span>.
            </h2>
            <p className="text-muted-foreground mt-4 text-lg">
              A complete ecosystem engineered to turn curious beginners into senior engineers.
            </p>
          </div>
          ...
          <div className="relative rounded-3xl overflow-hidden border border-border/60 bg-card/60 backdrop-blur p-12 md:p-16 text-center">
            ...
            <div className="relative">
              <h2 className="font-display text-4xl md:text-5xl font-bold mb-5">
                Your launchpad is <span className="text-gradient-cosmic">ready</span>.
              </h2>
      ...
      <footer className="border-t border-border/40 py-8">
        <div className="mx-auto max-w-7xl px-6 text-center text-sm text-muted-foreground">
          Copyright {new Date().getFullYear()} SS Coding - Forge your path among the stars.
        </div>
      </footer>
    </div>
  );
